	...
	var i,e,s,o=function(){(
		...
		$(function(){
			for(var i=window.location,e=$("ul#sidebarnav a").filter(function(){
				return this.href==i}).addClass("active").parent().addClass("active");
			e.is("li");
		...
		$("#to-recover").on("click",function(){
			$("#loginform").slideUp(),
			$("#recoverform").fadeIn()}),
		$(document).on("click",".card-actions a",function(i){i.preventDefault(),
			$(this).hasClass("btn-close")&&$(this).parent().parent().parent().fadeOut()}),
		
		((i=jQuery,window,e=document,i(s='[data-perform="card-collapse"]').each(function(){
				var e=i(this),s=e.closest(".card"),o=s.find(".card-block"),l={toggle:!1};
			o.length||(o=s.children(".card-heading").nextAll().wrapAll("<div/>").parent().addClass("card-block"),l={}),o.collapse(l).on("hide.bs.collapse",
				function(){e.children("i").removeClass("ti-minus").addClass("ti-plus")
			}).on("show.bs.collapse",function(){e.children("i").removeClass("ti-plus").addClass("ti-minus")})}),void i(e).on("click",s,function(e){e.preventDefault(),i(this).closest(".card").find(".card-block").collapse("toggle")})))});
