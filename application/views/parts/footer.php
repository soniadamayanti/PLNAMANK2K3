    ...
    <script type="text/javascript">
        var data = [
            ...
            Morris.Donut({
              element: 'pie-chart',
              data: [
                {label: "Preventif", value: 40},
                {label: "Korektif", value: 60}
              ]
            });
        ...
        $(document).on('click','#btnGenerateLaporan',function(){
            ...
            $('#table_rekap_bulanan').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excel',
                        title: 'Rekap Bulanan '+gardu+' '+tgl_awal+' - '+tgl_akhir,
                        messageTop: 'The information in this table is copyright to Sirius Cybernetics Corp.'
                    },
                    {
                        extend: 'pdf',
                    ...
                    {
                        extend: 'print',
                        title: 'Rekap Bulanan<br>'+gardu+' '+tgl_awal+' - '+tgl_akhir,
