                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control">
                                                <div class="custom-control custom-switch">
                                                  ...
                                                  <label class="custom-control-label" for="customSwitch2">Tanda Tangan Pekerja</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control">
                                                <div class="custom-control custom-switch">
                                                  ...
                                                  <label class="custom-control-label" for="customSwitch3">Tanda Tangan Pekerja</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control">
                                                <div class="custom-control custom-switch">
                                                  ...
                                                  <label class="custom-control-label" for="customSwitch4">Tanda Tangan Pekerja</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control">
                                                <div class="custom-control custom-switch">
                                                  ...
                                                  <label class="custom-control-label" for="customSwitch5">Tanda Tangan Pekerja</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control">
                                                <div class="custom-control custom-switch">
                                                  ...
                                                  <label class="custom-control-label" for="customSwitch6">Tanda Tangan Pekerja</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control">
                                                <div class="custom-control custom-switch">
                                                  ...
                                                  <label class="custom-control-label" for="customSwitch7">Tanda Tangan Pekerja</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control">
                                                <div class="custom-control custom-switch">
                                                  ...
                                                  <label class="custom-control-label" for="customSwitch8">Tanda Tangan Pekerja</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control">
                                                <div class="custom-control custom-switch">
                                                  ...
                                                  <label class="custom-control-label" for="customSwitch9">Tanda Tangan Pekerja</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control">
                                                <div class="custom-control custom-switch">
                                                  ...
                                                  <label class="custom-control-label" for="customSwitch10">Tanda Tangan Pekerja</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="customCheck1">Helm</label>
                                                </div>
                                            </div>  
                                            <div class="col-md-4">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="customCheck1">
                                                    <label class="custom-control-label" for="customCheck1">Sepatu</label>
                                                </div>
                                            </div>  
                                            <div class="col-md-4">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="customCheck1">
                                                    <label class="custom-control-label" for="customCheck1">Tas</label>
                                                </div>
                                            </div>  
                                            <div class="col-md-4">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="customCheck1">
                                                    <label class="custom-control-label" for="customCheck1">Peci</label>
                                                </div>
                                            </div>  
                                            <div class="col-md-4">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="customCheck1">
                                                    <label class="custom-control-label" for="customCheck1">Earmuff</label>
                                                </div>
                                            </div>
                                        </div>
